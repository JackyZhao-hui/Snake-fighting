...
//			this.add(text_answer);
			...
			btn_register.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if(text_account.getText().isEmpty() || String.valueOf(text_pass.getPassword()).isEmpty() ) {
						JOptionPane.showMessageDialog(Account.this, "账号、密码不能为空", "注册失败", JOptionPane.WARNING_MESSAGE);
					}
					else {
						if(users.isExist(text_account.getText())){
							...
							users.addUser(users.getUserCount()+1,text_account.getText() ,String.valueOf(text_pass.getPassword()));
